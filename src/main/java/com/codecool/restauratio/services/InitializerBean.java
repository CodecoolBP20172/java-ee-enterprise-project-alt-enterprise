...
public class InitializerBean {
    ...
    public InitializerBean(UserService userService, RestaurantService restaurantService, FoodRepository foodrepo) {
        ...
        Restaurant r2 = new Restaurant("Csirkés", "Fast Food", "Mány", list2, 50, user2, "/img/csirkes_image.jpeg");
        Restaurant r3 = new Restaurant("Titiz", "Fast Food", "Mány", list3, 10, user2, "/img/titiz_image.jpg");
        Restaurant r4 = new Restaurant("Donaldé", "Fast Food", "Everywhere", list3, 10, user2, "/img/titiz_image.jpg");
